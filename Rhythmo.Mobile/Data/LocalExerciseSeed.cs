...
public static class LocalExerciseSeed
{
	...
	[
		...
		("Pectoraux", "Développé décliné haltères"),
		("Pectoraux", "Chest press"),
		("Pectoraux", "Dips"),
		("Pectoraux", "Écarté haltères"),
		("Pectoraux", "Écarté poulie"),
		("Pectoraux", "Écarté haltères incliné"),
		("Pectoraux", "Écarté poulie incliné"),
		("Pectoraux", "Écarté haltères décliné"),
		...
		("Dos", "Rowing poulie unilatéral"),
		("Dos", "Soulevé de terre"),
		("Dos", "Pullover"),
		("Dos", "Shrug barre"),
		("Dos", "Shrug haltères"),
		("Dos", "Shrug machine"),
		("Dos", "Extension lombaire machine"),
		("Dos", "Rowing T-Bar"),
		("Dos", "Landmine 180"),
		// Épaules
		...
		("Épaules", "Élévations latérales poulie"),
		("Épaules", "Élévations latérales machine"),
		("Épaules", "Élévations frontales"),
		("Épaules", "Oiseau"),
		("Épaules", "Oiseau poulie"),
		("Épaules", "Reverse pec deck"),
		("Épaules", "Face pull"),
		...
		("Triceps", "Extension overhead poulie"),
		...
		("Jambes — Quadriceps", "Adducteur machine"),
		("Jambes — Quadriceps", "Adduction hanche poulie"),
		// Ischios / Fessiers
		...
		("Abdominaux", "Crunch machine"),
		("Abdominaux", "Crunch décliné lesté"),
		("Abdominaux", "Reverse crunch lesté"),
		...
		("Abdominaux", "Flexion latérale au banc"),
		// Poids du corps / Street Workout
